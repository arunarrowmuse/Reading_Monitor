...
class _ViewSteamBoilerState extends State<ViewSteamBoiler>  with AutomaticKeepAliveClientMixin<ViewSteamBoiler> {
  ...
  void FetchSteamReport() async {
    ...
    final response = await http.get(
      Uri.parse(
          '${Constants.weblink}ViewReportSteamBoilerDateSearchNew/${selectedDate.toString().split(" ")[0]}'),
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        borderRadius: const BorderRadius.all(
                                            Radius.circular(8))),
                                    child: Center(
                                      child: Text(data[0]['bfw_temperature'].toString(),
                                          style: TextStyle(
                                            // color: Colors.grey,
                                              fontFamily: Constants.popins,
                                              fontSize: 14)),
